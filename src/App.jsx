...
function App() {
  ...
  return (
    <>
      <div className="main w-screen lg:h-screen flex justify-center items-center text-white">
        <div className="calculator w-96 md:h-screen sm:h-screen border border-slate-200 border-solid rounded p-1">
